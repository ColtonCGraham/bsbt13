    ...
    if ("production" !== process.env.NODE_ENV) {
      ...
      try {
        ...
        (console.error = function (t) {
          ...
          v.test(t)
            ? ((a = !1), g.delete(s))
            : i.apply(void 0, __spreadArray([t], n, !1));
        }),
          useRef(),
          a && !g.has(s) && (console.warn(s), g.add(s));
      } catch (e) {
        v.test(e.message) && g.delete(s);
      } finally {
        console.error = i;
      }
    }
...
function E(e, t, n) {
  return (
    void 0 === n && (n = b), (e.theme !== n.theme && e.theme) || t || n.theme
  );
}
var N = new Set([
    "a",
...
var V = "function" == typeof Symbol && Symbol.for,
  F = V ? Symbol.for("react.memo") : 60115,
  M = V ? Symbol.for("react.forward_ref") : 60112,
  $ = {
    childContextTypes: !0,
    contextType: !0,
    contextTypes: !0,
...
function X(e, t, n) {
  if ("string" != typeof t) {
    ...
    for (var s = L(e), i = L(t), a = 0; a < o.length; ++a) {
      var c = o[a];
      if (!(c in z || (n && n[c]) || (i && c in i) || (s && c in s))) {
        var l = H(t, c);
        try {
          Y(e, c, l);
        } catch (e) {}
...
function ne(e, t, n) {
  if ((void 0 === n && (n = !1), !n && !te(e) && !Array.isArray(e))) return t;
  if (Array.isArray(t))
    for (var r = 0; r < t.length; r++) e[r] = ne(e[r], t[r]);
  else if (te(t)) for (var r in t) e[r] = ne(e[r], t[r]);
  return e;
}
var re =
  "production" !== process.env.NODE_ENV
...
function se(t) {
  ...
  return "production" === process.env.NODE_ENV
    ...
    : new Error(oe.apply(void 0, __spreadArray([re[t]], n, !1)).trim());
}
var ie = (function () {
    function e(e) {
  ...
  ue = function (e) {
    ...
    return ae.set(e, t), ce.set(t, e), t;
  },
  pe = function (e) {
    for (
      var t = e.getTag(),
        ...
        o = function (n) {
          ...
          var a = "".concat(h, ".g").concat(n, '[id="').concat(o, '"]'),
            c = "";
          void 0 !== s &&
...
var he = function (e) {
  ...
  ve = { isServer: !0, useCSSOMInjection: !m },
  ge = (function () {
    function e(e, n, r) {
      void 0 === e && (e = b),
        void 0 === n && (n = {}),
        (this.options = __assign(__assign({}, ve), e)),
        (this.gs = n),
          ...
          (this.tag =
            ((e = (function (e) {
              var t = e.useCSSOMInjection,
                n = e.target;
              return e.isServer ? new ye(n) : t ? new fe(n) : new me(n);
            })(this.options)),
            new ie(e)))
        );
        var e;
...
function Ee(e) {
  ...
  u.push(function (e) {
    e.type === RULESET &&
      e.value.includes("&") &&
      (e.props[0] = e.props[0].replace(Se, n).replace(r, l));
  }),
  ...
  var d = function (e, o, s, a) {
    ...
    i.namespace && (l = be(l, i.namespace));
    var d = [];
    return (
      serialize(
        l,
...
var je = function (e) {
  ...
  xe = function (t) {
    ...
    for (var s in t) {
      ...
      t.hasOwnProperty(s) &&
        !je(i) &&
        ((Array.isArray(i) && i.isCss) || Z(i)
          ? o.push("".concat(Te(s), ":"), i, ";")
          : te(i)
          ? o.push.apply(
              o,
              __spreadArray(
                __spreadArray(["".concat(s, " {")], xe(i), !1),
                ["}"],
                !1,
              ),
            )
...
function ke(e, t, n, r) {
  if (je(e)) return [];
  if (K(e)) return [".".concat(e.styledComponentId)];
  if (Z(e)) {
    if (!Z((s = e)) || (s.prototype && s.prototype.isReactComponent) || !t)
      return [e];
    var o = e(t);
    return (
      "production" === process.env.NODE_ENV ||
      ...
      (e.prototype.generateAndInjectStyles = function (e, t, n) {
        ...
        if (this.isStatic && !n.hash)
          if (
            ...
            r = Q(r, this.staticRulesId);
          else {
            var o = ee(ke(this.rules, e, t, n)),
              s = O(D(this.baseHash, o) >>> 0);
            if (!t.hasNameForId(this.componentId, s)) {
              var i = n(o, ".".concat(s), void 0, this.componentId);
              t.insertRules(this.componentId, s, i);
            }
            (r = Q(r, s)), (this.staticRulesId = s);
          }
        else {
          for (
            var a = D(this.baseHash, n.hash), c = "", l = 0;
            l < this.rules.length;
            l++
          ) {
            var u = this.rules[l];
            if ("string" == typeof u)
              (c += u), "production" !== process.env.NODE_ENV && (a = D(a, u));
            else if (u) {
              var p = ee(ke(u, e, t, n));
              (a = D(a, p)), (c += p);
            }
...
function Ye(e, r, o) {
  var s,
    ...
    d =
      void 0 === p
        ? (function (e, t) {
            var n = "string" != typeof e ? "sc" : C(e);
            Le[n] = (Le[n] || 0) + 1;
            var r = "".concat(n, "-").concat(j("6.0.0-rc.3" + n + Le[n]));
    ...
    f =
      void 0 === h
        ...
        : h,
    m = null !== (s = r.attrs) && void 0 !== s ? s : [],
    y =
      r.displayName && r.componentId
        ? "".concat(C(r.displayName), "-").concat(r.componentId)
        : r.componentId || d,
    v = i && a.attrs ? a.attrs.concat(m).filter(Boolean) : m,
  ...
  var _ = new Me(o, y, i ? a.componentStyle : void 0),
    I = _.isStatic && 0 === m.length;
  function A(e, n) {
    return (function (e, n, r, o) {
      ...
      "production" !== process.env.NODE_ENV && useDebugValue(p);
      var y = (function (e, n, r) {
          for (
            var o,
              s = __assign(__assign({}, n), { className: void 0, theme: r }),
              i = 0;
            i < e.length;
            i += 1
          ) {
          ...
          return n.className && (s.className = Q(s.className, n.className)), s;
        })(s, n, E(n, h, a) || b),
        v = y.as || d,
        g = {};
      for (var S in y)
      ...
      var w = (function (e, t, n) {
        var r = Ae(),
          o = e.generateAndInjectStyles(t ? b : n, r.styleSheet, r.stylis);
        return "production" !== process.env.NODE_ENV && useDebugValue(o), o;
      })(i, o, y);
      "production" !== process.env.NODE_ENV &&
        !o &&
        e.warnTooManyClasses &&
        e.warnTooManyClasses(w);
      var P = Q(u, p);
      return (
        w && (P += " " + w),
        y.className && (P += " " + y.className),
        (g[k(v) && !N.has(v) ? "class" : "className"] = P),
        (g.ref = r),
        createElement(v, g)
      );
    })(O, e, n, I);
  ...
  return (
    ...
    (O.foldedComponentIds = i
      ? Q(a.foldedComponentIds, a.styledComponentId)
      : ""),
    (O.styledComponentId = y),
    (O.target = i ? a.target : e),
        ...
        this._foldedDefaultProps = i
          ? (function (e) {
              for (var t = [], n = 1; n < arguments.length; n++)
                t[n - 1] = arguments[n];
              for (var r = 0, o = t; r < o.length; r++) ne(e, o[r], !0);
              return e;
            })({}, a.defaultProps, e)
          : e;
      },
    ...
    "production" !== process.env.NODE_ENV &&
      (S(f, y),
      (O.warnTooManyClasses = (function (e, t) {
        var n = {},
          r = !1;
        return function (o) {
...
function He(t) {
  ...
  if (Z(t) || te(t)) {
    var o = t;
    return qe(ke(We(w, __spreadArray([o], n, !0))));
  }
  var s = t;
  return 0 === n.length && 1 === s.length && "string" == typeof s[0]
    ? ke(s)
    : qe(ke(We(s, n)));
}
function Ue(n, r, o) {
  if ((void 0 === o && (o = b), !r)) throw se(1, r);
  var s = function (t) {
    for (var s = [], i = 1; i < arguments.length; i++) s[i - 1] = arguments[i];
    return n(r, o, He.apply(void 0, __spreadArray([t], s, !1)));
  };
  return (
    (s.attrs = function (e) {
      return Ue(
    ...
    (s.withConfig = function (e) {
      return Ue(n, r, __assign(__assign({}, o), e));
    }),
    s
  );
}
...
"production" !== process.env.NODE_ENV &&
  ...
  "production" !== process.env.NODE_ENV && process;

var StyledButton = Xe.button(
  templateObject_1$5 ||
...
var Button = function (_a) {
  var size = _a.size,
    ...
    text = _a.text,
    onClick = _a.onClick,
    props = __rest(_a, ["size", "primary", "disabled", "text", "onClick"]);
...
Xe.div(
  ...
  function (props) {
    return props.disabled ? "#a7a7d4" : "#080808";
  },
  function (props) {
    return props.disabled ? "not-allowed" : "default";
  },
...
Xe.th(
  ...
  function (props) {
    return props.disabled ? "#e4e3ea" : "#0328fc";
  },
);
Xe.td(
  templateObject_4$1 ||
  ...
  function (props) {
    return props.disabled ? "#e4e3ea" : "#30cfa9";
  },
);
...
Xe(StyledLi)(
  ...
  function (props) {
    return props.disabled ? "" : "red";
  },
  DropDownContent,
  function (props) {
    return props.disabled ? "" : "block";
  },
);
Xe.a(
  templateObject_6 ||
